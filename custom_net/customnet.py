...
paths = os.path.join(current_path,"custom_nodes","Comfyui_CustomNet")
...
from customnet_modules.attention import SpatialTransformer
from customnet_modules.openaimodel import UNetModel, TimestepEmbedSequential, ResBlock, Downsample, AttentionBlock
from models.ddpm import LatentDiffusion
